...
class ArtikelController
{
    ...
    public function voegArtikelToe($naam, $omschrijving, $prijs, $afbeelding, $idcategorie)
    {
        ...
        if (mysqli_query($dbh, $sql)) {
            echo "<div style='margin-top: 100px;' class='alert alert-success'><strong>Gelukt!</strong> Artikel <strong>$naam</strong> is toegevoegd!</div>";
        } else {
    ...
    public function wijzigArtikel($idartikel, $naam, $omschrijving, $prijs,$afbeelding, $categorie) {
        ...
        if (mysqli_query($dbh, $sql)) {
            echo "<div style='margin-top: 100px;' class='alert alert-success'><strong>Gelukt!</strong> Het artikel is gewijzigd!</div>";
        } else {
            echo "Error: " . $sql . "<br>" . mysqli_error($dbh);
        }
    }
    ...
    public function verwijderArtikel($id)
    {
        ...
        if (mysqli_query($dbh, $sql)) {
            echo "<div style='margin-top: 100px;' class='alert alert-danger'><strong>Letop!</strong> Artikel $id is verwijderd!</div>";
        } else {
            echo "Error: " . $sql . "<br>" . mysqli_error($dbh);
        }
    }
