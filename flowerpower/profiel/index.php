...
<div class="card" style="border: 1px solid #FF6F83; width: 100%; height: 150%; margin-bottom: 100px;">
    <div class="container1">
        <li class="li"><a href="#" class="cool-link">
        ...
        <li class="li" style="margin-left: 50px"><a href="#" class="cool-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                     class="bi bi-person-fill" viewBox="0 0 16 16">
                    <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                </svg>
            </a></li>
        <li class="li" style="margin-left: -5px"><a href="#" class="cool-link">Contact</a></li>
        <li class="li" style="margin-left: -5px"><a href="#" class="cool-link">Gelegenheid</a></li>
        <li class="li" style="margin-left: -5px"><a href="#" class="cool-link">Bloemen</a></li>
