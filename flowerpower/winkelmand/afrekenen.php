                                ...
                                <div class="column" style="width: 50%">
                                    <div class="card-body" style="text-align: left">
                                        ...
                                        <span><h4 class="card-title"
                                                  style="margin-top: 40px; font-size: 18px; font-weight: bold;">Openingstijden</h4></span>
                                        <p class="card-text" style="margin-bottom: -6px; font-size: 17px;">Ma/za -<span> 8:30 t/m 18:00</span>
                                        </p>
