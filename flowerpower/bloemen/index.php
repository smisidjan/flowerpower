...
<div class="row" style="margin-top: 100px; margin-bottom: 400px;">
    <div class="column">
        <form action="index.php" method="post">
            <div class="card <?php if (isset($_POST['alle'])) { echo "active1";} ?>">
    ...
    <div class="column">
        <form action="index.php" method="post">
            <div class="card <?php if (isset($_POST['pluk'])) { echo "active1";} ?>">
    ...
    <div class="column">
        <form action="index.php" method="post">
            <div class="card <?php if (isset($_POST['voorjaars'])) { echo "active1";} ?>">
