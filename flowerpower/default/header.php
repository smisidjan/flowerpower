...
<div class="container1" style="float: right;">
    <div class="topnav" style="float: right; width: 600px; background-color: white;">
        ...
        <?php } ?>
        <a <?php if ($_SERVER['PHP_SELF'] == '/flowerpower/winkelmand/index.php') {echo "class='active'";} elseif ($_SERVER['PHP_SELF'] == '/flower-power/winkelmand/afrekenen.php') {echo "class='active'";} ?> href="../winkelmand/index.php">
